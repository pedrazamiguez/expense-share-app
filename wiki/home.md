...
* **[Group Pocket Balance Model & Metrics](group-pocket-balance-model.md)**: The core formulas, remaining/available/scheduled/on-hold definitions, and per-member balance metrics.

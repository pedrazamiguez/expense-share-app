 ...
 * @param totalExtras Sum of all non-discount add-ons across expenses (both ON_TOP and INCLUDED)
 *                    plus ATM fee add-ons on withdrawals (in cents).
 *                    Includes fees, tips, and surcharges whether they were added on top of the
 *                    base cost or were already embedded in the user-entered total (INCLUDED).

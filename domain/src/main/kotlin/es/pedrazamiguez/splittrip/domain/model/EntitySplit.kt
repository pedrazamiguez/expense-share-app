...
/**
 * Represents an entity-level share (Level 1) in two-level subunit-aware splitting.
 *
 * An "entity" is either a solo user or a subunit treated as a single participant.
 * This model carries the entity's share of the total expense before it is expanded
 * into per-user [ExpenseSplit] entries.
 *
 * @param entityId  User ID for solo participants, subunit ID for subunits.

...
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_27_28
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_28_29
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_29_30
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_2_3
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_30_31
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_31_32
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_32_33
import es.pedrazamiguez.splittrip.data.local.database.migration.MIGRATION_38_39
...
internal val ALL_MIGRATIONS = arrayOf(
    ...
    MIGRATION_31_32, MIGRATION_32_33, MIGRATION_38_39
)

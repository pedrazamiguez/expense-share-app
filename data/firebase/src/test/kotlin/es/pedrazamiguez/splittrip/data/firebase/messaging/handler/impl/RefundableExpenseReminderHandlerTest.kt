...
@DisplayName("RefundableExpenseReminderHandler")
class RefundableExpenseReminderHandlerTest {

    private val context: Context = mockk()
    private val handler = RefundableExpenseReminderHandler(context)

    @Test
    @DisplayName("handle creates correct NotificationContent")
    fun handle() {
        every { context.getString(R.string.notification_refundable_reminder_title) } returns "title"
        every { context.getString(R.string.notification_refundable_reminder_body) } returns "body"

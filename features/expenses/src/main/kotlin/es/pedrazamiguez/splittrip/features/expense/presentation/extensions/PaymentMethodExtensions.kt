...
fun PaymentMethod.toIconVector(): ImageVector = when (this) {
    ...
    PaymentMethod.BIZUM -> TablerIcons.Outline.BrandBebo
    PaymentMethod.PIX -> TablerIcons.Outline.BrandPaypay
    ...
    PaymentMethod.PAYPAL -> TablerIcons.Outline.BrandPaypal
    PaymentMethod.VENMO -> TablerIcons.Outline.BrandVivaldi
    PaymentMethod.ALIPAY -> TablerIcons.Outline.BrandAlipay
    PaymentMethod.WECHAT_PAY -> TablerIcons.Outline.BrandWechat
    PaymentMethod.OTHER -> TablerIcons.Outline.Qrcode
}
